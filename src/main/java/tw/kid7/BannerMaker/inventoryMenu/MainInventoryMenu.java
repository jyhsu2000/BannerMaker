...
public class MainInventoryMenu extends AbstractInventoryMenu {
    ...
    public void open(final Player player) {
        ...
        for (int i = 0; i < bannerList.size() && i < 45; i++) {
            ...
            menu.setClickableItem(i, banner).set(ClickType.LEFT, new CustomGUIItemListener() {
                @Override
                public void action() {
        ...
        if (currentPage > 1) {
            ...
            menu.setClickableItem(45, prevPage).set(ClickType.LEFT, new CustomGUIItemListener() {
                @Override
                public void action() {
        ...
        if (currentPage < totalPage) {
            ...
            menu.setClickableItem(53, nextPage).set(ClickType.LEFT, new CustomGUIItemListener() {
                @Override
                public void action() {
                    playerData.setCurrentPage(currentPage + 1);
                    InventoryMenuUtil.openMenu(player);
        ...
        menu.setClickableItem(49, btnCreateBanner).set(ClickType.LEFT, new CustomGUIItemListener() {
            @Override
            public void action() {
        ...
        if (BannerMaker.getInstance().enableAlphabetAndNumber) {
            ...
            menu.setClickableItem(51, btnCreateAlphabet).set(ClickType.LEFT, new CustomGUIItemListener() {
                @Override
                public void action() {
