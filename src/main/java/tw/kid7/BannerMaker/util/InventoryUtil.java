...
public class InventoryUtil {
    ...
    static public void openMainMenu(Player player) {
        //建立選單
        Inventory menu = Bukkit.createInventory(null, 54, MessageUtil.cutString(MessageUtil.format("&b&m&r" + Language.get("gui.main-menu")), 32));
        //當前頁數
    ...
    static public void openCreateBanner(Player player) {
        //建立選單
        Inventory menu = Bukkit.createInventory(null, 54, MessageUtil.cutString(MessageUtil.format("&b&m&r" + Language.get("gui.create-banner")), 32));
        //取得當前編輯中的旗幟
    ...
    static public void openBannerInfo(Player player) {
        //建立選單
        Inventory menu = Bukkit.createInventory(null, 54, MessageUtil.cutString(MessageUtil.format("&b&m&r" + Language.get("gui.banner-info")), 32));
        //索引值
