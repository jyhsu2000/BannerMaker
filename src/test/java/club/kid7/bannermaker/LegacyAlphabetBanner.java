 ...
 */
public class LegacyAlphabetBanner {
     ...
     * 建構子
     */
    public LegacyAlphabetBanner(String alphabet, DyeColor baseColor, DyeColor dyeColor, boolean bordered) {
    ...
    public static ItemStack get(String alphabet, DyeColor baseColor, DyeColor dyeColor, boolean bordered) {
        LegacyAlphabetBanner alphabetBanner = new LegacyAlphabetBanner(alphabet, baseColor, dyeColor, bordered);
     ...
     * @return boolean
     */
    static public boolean isLegacyAlphabetBanner(ItemStack itemStack) {
